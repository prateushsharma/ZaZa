...
### Trading Features
- **Market Analysis**: Analyze SUI/USDC market data
...
│   └── SUIStore.js       # SUI/SUI trading state
│
├── styles/                  # CSS styles
│   ├── AgentDetail.css
│   ├── AgentLogs.css
...
- **store/**: State management using Zustand
  ...
  - **SUIStore.js**: Manages trading-related state
...
**Project Repository**:  
[https://github.com/RudrakshSJoshi/SUI_Hack](https://github.com/RudrakshSJoshi/SUI_Hack)  
