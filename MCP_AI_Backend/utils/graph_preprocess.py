  ...
  "nodes": [
    {
      "id": "s638",
      "type": "startNode",
      "position": { "x": 182, "y": 357 },
      "data": {}
    },
    {
      "id": "a174",
      "type": "agentNode",
      "position": { "x": 486, "y": 323 },
      "data": {
    ...
    },
    {
      ...
      "position": { "x": 564, "y": 93 },
      "data": {
        "strategyText": "Purchase when price of 1 sui is 3.25 and sell when it is 3.3$"
      }
    },
    {
      "id": "m197",
      "type": "modelNode",
      "position": { "x": 215, "y": 595 },
      "data": {
        "model": "gpt4",
        "parentId": "a174"
      }
...
output_json = filter_workflow_json(input_json)
